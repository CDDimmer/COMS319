...
function App() {
  ...
  function ReadView() {
    ...
    function LoadProduct() {
      var singleRobotInput = document.getElementById("SingleRobotByID");
  ...
  function UpdateView() {
    ...
    function changePricePrompt() {
      let price = prompt("Please enter a different price", products[index].price);
      if (price != null && price != products[index].price) {
        console.log(price);
      }
    }
    ...
    return (
      <div className="container">
        ...
        <h3 class="text-center">Select a product to update:</h3>
        <div class="row">
          ...
          <div class="col text-center" key={products[index].id}>
            ...
            Rating :{products[index].rating.rate} (Averaged over{" "}
            {products[index].rating.count} rating/s)
            <br />
          </div>
          <button class="btn col-1" onClick={() => getOneByOneProductNext()}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
              height="50"
        ...
        <div class="row">
          <div class="col"></div>
          <button
            class="btn border-black col-4 btn-outline-success"
            onClick={() => changePricePrompt()}
          >
            Update This Product
          </button>
          <div class="col"></div>
